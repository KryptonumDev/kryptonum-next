...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source:
          "/page-data/blog/jak-zdobyc-pierwszego-klienta/mailtokuba@kryptonum.eu/page-data.json",
        destination: "/pl/blog",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          "/pl/akademia/jak-wybrac-technologie-projektowania-stron-www",
        permanent: true,
      },
      {
        source: "/blog/cargem",
      ...
      {
        source:
          "/pl/akademia/cyberataki-przyklady-i-rodzaje-atakow-hakerskich-cyberbezpieczenstwo",
        destination: "/pl/akademia",
        permanent: true,
      },
    ];
