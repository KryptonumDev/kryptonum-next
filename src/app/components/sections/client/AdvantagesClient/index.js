...
const AdvantagesClient = ({ advantages, simpleCtaSection, children }) => {
		...
		<section className={styles.section}>
			...
			<div className={styles.advantages}>
				{advantages.map((advantage, i) => (
					<div
						className={`${styles.advantagesItem} advantages-item`}
						key={i}
						data-scale={scales[`scale${i + 1}`]}
					>
						...
						<div className={i%2===0 ? styles.imageWrapper : `${styles.imageWrapper} ${styles.reverse}`}>
							...
							<div
								...
								style={{ transform: `scaleX(${scales[`scale${i + 1}`]})` }}
							/>
						</div>
					</div>
				))}
...
export default AdvantagesClient;
