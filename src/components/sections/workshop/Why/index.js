...
const Why = ({
  data: { why_Heading, why_Paragraph, why_SecondParagraph, why_ThirdParagraph, why_FourthParagraph, why_Cta },
}) => {
  return (
    <section className={styles.section}>
      <DecorativeHeading type="h2">{why_Heading}</DecorativeHeading>
      ...
      <div className={styles.paragraph4}>
        ...
        <Button data={why_Cta} className={styles.cta} />
      </div>
    </section>
  );
};
